...
func LoadCreateQuestions(name, topicID string, numberOfQuestion int) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<head><meta charset=\"UTF-8\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"><script src=\"https://unpkg.com/htmx.org@1.9.2\"></script><title>Create Question for Topic</title><link rel=\"stylesheet\" href=\"/static/css/components/CreateQuestion.css\"><link rel=\"stylesheet\" href=\"/static/css/components/CreateQuestionComponent.css\"></head><body>")
		if templ_7745c5c3_Err != nil {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "<div class=\"questionsCreation\"><form id=\"creatingQuestionForm\" hx-post=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		for i := 0; i < numberOfQuestion; i++ {
			templ_7745c5c3_Err = components.CreateQuestion(i).Render(ctx, templ_7745c5c3_Buffer)
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
